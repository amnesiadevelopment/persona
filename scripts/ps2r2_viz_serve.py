...
_eng.rollback_target = lambda: ("chromium-148.0.7778.203-linux64", "/x")
...
_inv.rollback_target = lambda: "firefox-142"
...
def main() -> None:
    home = sys.argv[1] if len(sys.argv) > 1 else "/tmp/ps2r2-viz-home"
