...
// persona lime aurora over pure black, fading to black at the edges.
const DEFAULT_COLORS = ['#c6f24e', '#97ca00', '#3f5a00', '#000000']
...
const Velaris = ({
  ...
  useEffect(() => {
    ...
    let raf = 0
    if (reduceMotion) {
      // Paint one static frame and stop — respects prefers-reduced-motion.
      draw(0)
    } else {
