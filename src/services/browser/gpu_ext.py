...
__LEAF_CLOAK__
  ...
  // RENDERER STRING (PS-380 slice 3). A detector does not need to know the right
  ...
  //     (the PS-380 liaison control): engine 35 entries, persona 27. EIGHT
  ...
  //   papered over: see `tests/test_ps380_desktop_ext_set.py`, which pins both
  ...
  // THIS arm's engine order has no such quirk, and a first draft of the PS-380
