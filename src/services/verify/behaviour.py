...
UNCOVERED_SURFACES: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "InvisibleProcess) above a 10-to-11 process Gecko tree — a forkserver, "
        "a Socket Process, WebExtensions, an RDD Process, a Utility Process and "
        "four Web Content children — measured three times by three tickets: "
        "readings/ps171-2026-08-25/REPORT.md:405 (6 processes at one tab, 11 at "
