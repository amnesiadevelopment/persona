...
def _log_message_color(message: str) -> str:
...
def _log_line_control(line: str):
    ...
    return ft.Text(
        spans=[
            ...
            ft.TextSpan(
                rest,
                ft.TextStyle(color=_log_message_color(rest), size=11),
            ),
        ],
    ...
    def _flush_log(self) -> None:
        ...
        if text is not None and self.refs:
            ...
            self.refs.log_list.controls = [
                _log_line_control(ln) for ln in sidebar_lines
            ]
